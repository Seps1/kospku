		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 text-center mx-auto">
					<h1 class="text-white pt-3 mt-n5">Kost Pekanbaru</h1>
				</div>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="p-3 text-center">
							...
							<p class="text-sm">Save 3-4 weeks of work when you use our pre-made pages for your website
							</p>
						</div>
					</div>
				</div>
	...
	<div class="container">
				...
				<div class="row justify-content-start">
					<div class="col-md-6">
						<div class="info">
							...
							<p class="pe-5">Built by developers for developers. Check the foundation and you will find
								everything inside our documentation.</p>
						</div>
					</div>
					<div class="col-md-6">
						<div class="info">
		...
		<div id="map" class="map">
			<!-- <script type="text/javascript">
				const DEFAULT_COORD = [0.5089844891200336, 101.45044333334347]
				var map = L.map('map', {
			...
			<script>
				...
				// var rawan_kos = L.icon({
				// 	iconUrl: 'php echo base_url("assets/logo/kuning.png") ?>',


				// 	iconSize: [25], // size of the icon

				// });
				// var tidak_kos = L.icon({
				// 	iconUrl: php echo base_url("assets/logo/hijaucars.png") ?>',


				// 	iconSize: [25], // size of the icon

				// });
				// var kos_parah = L.icon({
				// 	iconUrl: '?php echo base_url("assets/logo/merah.png") ?>',


				// 	iconSize: [25], // size of the icon

				// });
				// var layerGroupkos = L.layerGroup().addTo(map);
				// var layerGroupkosparah = L.layerGroup().addTo(map);
				var layerGroupsemua = L.layerGroup();
				// masuk icon kos
				<?php
				// looping data kos
				foreach ($kos as $data) { ?>
					var kosmarker = L.marker([<?php echo $data['latitude'] ?>, <?php echo $data['longitude'] ?>], {icon: kosicon
					...
					// ini untuk icon yang kategori kos 
...
<section class="my-5 py-5">
	<div class="container">
		<form method="post" action="<?php echo base_url('Dashboard/search')  ?>">
				<input type="text" class="form-control w-100 mt-5 " name="nama"/>
				<div class="d-flex justify-content-center mt-3">
			  	<button class="btn btn-primary w-70" type="submit" >Cari</button>
		...
		<div class="row">
			<div class="row justify-content-center text-center my-sm-5">
				<div class="col-lg-6">
					...
					<p class="lead">We have created multiple options for you to put together and customise into pixel
						perfect pages. </p>
				</div>
			</div>
		</div>
	...
	<div class="container mt-sm-5 mt-3">
		...
		<div class="row pt-lg-6">
			<div class="col-lg-3">
				<div class="position-sticky pb-lg-5 pb-3 mt-lg-0 mt-5 ps-2" style="top: 100px">
					<h3>Navigation</h3>
					<h6 class="text-secondary font-weight-normal pe-3">30+ components that will help go through the
						pages</h6>
				</div>
			</div>
			<div class="col-lg-9">
		...
		<div class="row pt-lg-6">
			<div class="col-lg-3">
				<div class="position-sticky pb-lg-5 pb-3 mt-lg-0 mt-5 ps-2" style="top: 100px">
					<h3>Input Areas</h3>
					<h6 class="text-secondary font-weight-normal pe-3">50+ elements that you need for text manipulation
						and insertion</h6>
				</div>
			</div>
			<div class="col-lg-9">
		...
		<div class="row">
			<div class="col-lg-3">
				<div class="position-sticky pb-lg-5 pb-3 mt-lg-0 mt-5 ps-2" style="top: 100px">
					<h3>Elements</h3>
					<h6 class="text-secondary font-weight-normal pe-3">80+ carefully crafted small elements that come
						with multiple colors and shapes</h6>
				</div>
			</div>
			<div class="col-lg-9">
				<div class="row mt-3">
		...
		<div class="row">
			<div class="row text-center my-sm-5 mt-5">
				<div class="col-lg-6 mx-auto">
					...
					<p class="lead">The easiest way to get started is to use one of our <br /> pre-built example pages.
					</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-3 mx-auto mt-md-0 mt-5">
				<div class="position-sticky" style="top:100px !important">
					...
					<h6 class="text-secondary">These is just a small selection of the multiple possibitilies you have.
						Focus on the business, not on the design.</h6>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 ms-lg-5">
					...
					<p class="lead text-white opacity-8">From colors, cards, typography to complex elements, you will
						find the full documentation. Play with the utility classes and you will create unlimited
						combinations for our components.</p>
	...
	<div class="row">
		<div class="col-lg-4">
			<div class="info-horizontal bg-gradient-primary border-radius-xl p-5">
				...
				<div class="description ps-5">
					...
					<p class="text-white">Check the possible ways of working with our product and the necessary files
						for building your own project.</p>
					<a href="https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-design-system" class="text-white icon-move-right">
						Let's start
						<i class="fas fa-arrow-right text-sm ms-1"></i>
					</a>
		...
		<div class="col-lg-4 px-lg-1 mt-lg-0 mt-4">
			<div class="info-horizontal bg-gray-100 border-radius-xl p-5">
				...
				<div class="description ps-5">
					<h5>Plugins</h5>
					<p>Get inspiration and have an overview about the plugins that we used to create the Soft UI Design
						System.</p>
		...
		<div class="col-lg-4 mt-lg-0 mt-4">
			<div class="info-horizontal bg-gray-100 border-radius-xl p-5">
				...
				<div class="description ps-5">
					...
					<p>Soft UI Design System is giving you a lot of pre-made elements. For those who want flexibility,
						we included many utility classes.</p>
					<a href="" class="text-primary icon-move-right">
						Read more
						<i class="fas fa-arrow-right text-sm ms-1"></i>
					</a>
			...
			<div class="col-lg-4 col-md-8">
				<div class="card card-plain">
					<div class="card-body">
						...
						<p class="mt-4">"This is an excellent product, the documentation is excellent and helped me get
							things done more efficiently."</p>
			...
			<div class="row">
				<div class="col-md-7 mx-auto text-center">
					...
					<p class="text-white mb-5">Cause if you do, it can be yours for FREE. Hit the button below to
						navigate to Creative Tim where you can find the Design System in HTML. Start a new project or
						give an old Bootstrap project a new look!</p>
		...
		<div class="row">
			<div class="col-md-7 col-12 my-auto">
				...
				<p class="pe-md-5 mb-4">
					...
					designed blocks and fully coded pages, Soft UI Design System is ready to help you create stunning
		...
		<div class="row">
			...
			<div class="col-lg-5 col-md-12 ms-auto order-1 order-md-1 order-lg-1">
				<div class="p-3 pt-0">
					...
					<h4 class="mb-4"><a href="https://twitter.com/dnyivn" target="blank" rel="nofollow">3D Images by
							Danny Ivan</a></h4>
					<p>We are more than happy to use the great images made by Danny inside Soft UI Design System. They
						come with a high level of quality and bright colors, fitting perfect with our product's
						colors.<br><br> Danny is a important designer that is active into the 3D Image space. His war
						was awarded many times in different categories in Behance, Digital Art or Motion Graphics.</p>
...
<script>
	...
	?>
		for (var i = 0; i <= <?php echo $jumlah ?>; i++) {
			new L.marker([<?php echo $data['latitude'] ?>, <?php echo $data['longitude'] ?>]).addTo(map)
				.bindPopup("<img src= '" + '<?php echo $data['gambar'] ?>' + "' width='150px'" + "/> <div>Nama jalan : " + '<?php echo $data['nama_jalan'] ?>' + "</br>kondisi :" + '<?php echo $data['kondisi_jalan'] ?>' + "</br>Volume(/15 min) :" + '<?php echo $data['volume_kendaraan'] ?>' + "</br>Status : kos</div>")
				.closePopup();
		}
	<?php } ?>
</script>